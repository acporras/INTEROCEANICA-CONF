...
namespace FinalXML.Sunat {
    ...
    public interface billService {
        ...
        FinalXML.Sunat.sendBillResponse sendBill(FinalXML.Sunat.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<FinalXML.Sunat.sendBillResponse> sendBillAsync(FinalXML.Sunat.sendBillRequest request);
        ...
        FinalXML.Sunat.sendSummaryResponse sendSummary(FinalXML.Sunat.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<FinalXML.Sunat.sendSummaryResponse> sendSummaryAsync(FinalXML.Sunat.sendSummaryRequest request);
        ...
        FinalXML.Sunat.getStatusResponse getStatus(FinalXML.Sunat.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<FinalXML.Sunat.getStatusResponse> getStatusAsync(FinalXML.Sunat.getStatusRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public FinalXML.Sunat.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(FinalXML.Sunat.statusResponse status) {
            this.status = status;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : FinalXML.Sunat.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<FinalXML.Sunat.billService>, FinalXML.Sunat.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FinalXML.Sunat.sendBillResponse FinalXML.Sunat.billService.sendBill(FinalXML.Sunat.sendBillRequest request) {
            return base.Channel.sendBill(request);
        }
        
        public byte[] sendBill(string fileName, byte[] contentFile) {
            FinalXML.Sunat.sendBillRequest inValue = new FinalXML.Sunat.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            FinalXML.Sunat.sendBillResponse retVal = ((FinalXML.Sunat.billService)(this)).sendBill(inValue);
            return retVal.applicationResponse;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FinalXML.Sunat.sendBillResponse> FinalXML.Sunat.billService.sendBillAsync(FinalXML.Sunat.sendBillRequest request) {
            return base.Channel.sendBillAsync(request);
        }
        
        public System.Threading.Tasks.Task<FinalXML.Sunat.sendBillResponse> sendBillAsync(string fileName, byte[] contentFile) {
            FinalXML.Sunat.sendBillRequest inValue = new FinalXML.Sunat.sendBillRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            return ((FinalXML.Sunat.billService)(this)).sendBillAsync(inValue);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FinalXML.Sunat.getStatusResponse FinalXML.Sunat.billService.getStatus(FinalXML.Sunat.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public FinalXML.Sunat.statusResponse getStatus(string ticket) {
            FinalXML.Sunat.getStatusRequest inValue = new FinalXML.Sunat.getStatusRequest();
            inValue.ticket = ticket;
            FinalXML.Sunat.getStatusResponse retVal = ((FinalXML.Sunat.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FinalXML.Sunat.getStatusResponse> FinalXML.Sunat.billService.getStatusAsync(FinalXML.Sunat.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<FinalXML.Sunat.getStatusResponse> getStatusAsync(string ticket) {
            FinalXML.Sunat.getStatusRequest inValue = new FinalXML.Sunat.getStatusRequest();
            inValue.ticket = ticket;
            return ((FinalXML.Sunat.billService)(this)).getStatusAsync(inValue);
        }
    }
}
