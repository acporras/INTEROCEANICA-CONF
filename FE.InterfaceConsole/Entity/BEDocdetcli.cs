...
{
    public partial class BEDocdetcli
    {
        public BEDocdetcli()
        {
        ...
        public string f6_cisctip { get; set; }
        public Decimal f6_niscmon { get; set; }
        public Decimal f6_niscpre { get; set; }
    }

    public partial class ListBEDocdetcli : List<BEDocdetcli>
    {
